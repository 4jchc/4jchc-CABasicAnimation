...
class ViewControllerCAShapeLayer: UIViewController {
    ...
    private func setup01() {
        ...
        starShapeLayer.frame        = CGRectMake(200, 300, 80, 80)
        starShapeLayer.path         = starPath01.CGPath
        starShapeLayer.fillColor    = UIColor.randomColor().CGColor
        starShapeLayer.strokeColor  = UIColor.randomColor().CGColor
        starShapeLayer.lineWidth    = 2
        starShapeLayer.backgroundColor = UIColor.randomColor().CGColor
    ...
    private func setup02() {
        ...
        // 分别修改贝塞尔曲线的填充颜色
        ovalLayer.fillColor         = UIColor.randomColor().CGColor
        rectLayer.fillColor         = UIColor.randomColor().CGColor
        circleLayer.fillColor       = UIColor.randomColor().CGColor
    ...
    private func setup03() {
        ...
        progressLayer.fillColor         = UIColor.randomColor().CGColor
        progressLayer.strokeColor       = UIColor.randomColor().CGColor
    ...
    private func setup04() {
        ...
        progressView.lineColor  = UIColor.randomColor()
