...
class ViewControllerMZ1: UIViewController {
    ...
    */
    @IBAction func typeTwo() {
        ...
        UIView.animateWithDuration(2, delay: 0, options: [.CurveLinear , .Repeat , .Autoreverse], animations: { () -> Void in
    ...
    */
    @IBAction func typeFour() {
        ...
        UIView.animateWithDuration(2, delay: 0, options: [.CurveLinear , .Repeat , .Autoreverse], animations: { () -> Void in
            ...
            UIView.animateWithDuration(6, delay: 0, options: [.CurveLinear , .Repeat , .Autoreverse,.OverrideInheritedDuration], animations: { () -> Void in
    ...
    */
    @IBAction func typeFive() {
        ...
        UIView.transitionWithView(self.view01Subview, duration: 2, options: [.CurveLinear , .Repeat , .Autoreverse], animations: { () -> Void in
