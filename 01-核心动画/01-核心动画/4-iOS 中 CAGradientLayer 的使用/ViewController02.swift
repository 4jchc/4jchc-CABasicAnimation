...
class ViewController02: UIViewController {
    ...
    private func setup01() {
        ...
        dashCircleLayer = CAShapeLayer.instance(circleCenter: CGPointMake(radius, radius), radius: radius - 8, startAngle: startAngle, endAngle: endAngle, clockwise: true, lineDashPattern: [20,20])
